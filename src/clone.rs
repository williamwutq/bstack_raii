...
/// **without** needing an allocator. For handles that clone by bumping an on-disk
/// refcount ([`crate::BStackRc`], [`crate::BStackWeak`]).
...
///
/// Generated by `#[bstack_block]` for plain blocks. Owned children are deep
/// copied; shared (`#[bstack_strong]` / `#[bstack_weak]`) children stay shared
/// (their refcount is bumped); POD and `#[bstack_ref]` fields are byte-copied.
