...
pub fn alloc_block<A: BStackRaiiAllocator>(
    allocator: &A,
    tag: EightCC,
    size: u64,
...
pub fn set_weak_field<'w, T: BStackWeakable, A: BStackRaiiAllocator>(
    allocator: &A,
    field_off: u64,
...
pub fn upgrade_weak_field<'a, T: BStackWeakable, A: BStackRaiiAllocator>(
    allocator: &'a A,
    field_off: u64,
