...
use crate::io_core::TryCloneIn;
use crate::types::compiled::BStackOwned;
use crate::types::traits::{AutoDrop, BStackBlock, BStackDrop, BStackRef};
...
impl<T: BStackBlock> BStackCow<T> {
    ...
    pub fn into_owned<A: BStackRaiiAllocator>(self, allocator: &A) -> io::Result<BStackOwned<T>>
    where
        T: TryCloneIn,
    {
        match self {
    ...
    pub fn to_mut<A: BStackRaiiAllocator>(
        &mut self,
        allocator: &A,
